...
These are the most unorthodox requirements. Mind other requirements might still apply, such as `nodejs` to be available in your environment, or that you have `C` and `C++` compilers. The list below has the requirements (at the time this was set up) that I deemed less probable to be generally present in people's environments.
